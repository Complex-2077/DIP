...
# 打开两个图像
image1 = Image.open('/Users/complex/Downloads/血管实验数据/IMG/Med-Coronary-ARCADE-3.png').convert('L')
image2 = Image.open('./frangi.png').convert('L')
...
# 保存结果图像
result_image.save('result_image_frange.jpg')